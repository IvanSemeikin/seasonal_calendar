...
fig.add_trace(go.Bar(x=df['День'], y=df['Продажи'], name='Продажи', yaxis='y1', marker=dict(color=[0, 1, 2], colorscale='Viridis'), width=0.4))  # colorscale='Viridis'  marker_color='blue'
...
fig.add_trace(go.Scatter(x=df['День'] + 0.2, y=df['Средний_чек'], mode='lines', name='Средний чек', yaxis='y3', marker_color='pink'))
